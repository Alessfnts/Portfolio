document.addEventListener("DOMContentLoaded", function () {
  ...
  mentionsModal.innerHTML = `
    <div class="mentions-content">
      <div class="mentions-header">
        ...
        <button class="mentions-close">&times;</button>
      </div>
      <div class="mentions-body">
        ...
        <h3>3. Contact</h3>
        <p><a href="mailto:aless.fuentes6@gmail.com" target="_blank" rel="noopener noreferrer">aless.fuentes6@gmail.com</a></p>

        <h3>4. Directeur de la publication</h3>
        <p>Alessandro FUENTES</p>

        <h3>5. URL du site</h3>
        <p>https://Alessfnts.github.io/Portfolio</p>
  ...
  // Open mailto links without replacing the current page
  ...
  const observerOptions = {
    threshold: 0.1,
    rootMargin: "0px 0px -20px 0px" /* ← -20px au lieu de -50px */,
  };
  ...
  document
    .querySelectorAll(
      ".header, .section, .card, .card--glow, .mission-item, .option-card, .info-card, .project-container",
    )
